...
import { ShapeElement, LineElement } from '@image-edit/types/canvas';
import {
...
export function ShapeEditPanel() {
    ...
    const selectedElement = useMemo(() => {
        ...
        return (el?.type === 'shape' || el?.type === 'line') ? el as (ShapeElement | LineElement) : null;
        ...
        <div className="w-64 h-full flex flex-col bg-white border-l border-gray-200">
            ...
            <div className="p-4 border-b border-gray-200">
                <h2 className="text-gray-800 font-semibold text-sm">
                    {selectedElement?.type === 'line' ? 'Edit Line' : 'Edit Shape'}
                </h2>
            </div>
                ...
                {isDisabled && (
                    <div className="px-4">
                        <div className="text-center text-gray-400 text-xs py-4">
                            Select a shape element to edit
                        </div>
                    </div>
                )}
            </div>
