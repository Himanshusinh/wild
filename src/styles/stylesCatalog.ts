...
export const STYLE_CATALOG: StyleDef[] = [
  ...
  { name: '3D Cartoon', value: '3d_cartoon', image: '/styles/3d_cartoon.jpg', description: '3D cartoon style', prompt: '3D cartoon illustration of a friendly character; vibrant colors, smooth surfaces, playful proportions, stylized 3D rendering.' },
