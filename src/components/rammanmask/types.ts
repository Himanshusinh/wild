...
export interface RammanmaskState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Rammanmask" },
  V2: { badge: "ARTISAN", title: "Dimensional Rammanmask" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Rammanmask" },
};

export const INITIAL_STATE: RammanmaskState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
