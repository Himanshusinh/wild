...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Karepa Windows (Goa)" },
  V2: { badge: "ARTISAN", title: "Dimensional Karepa Shell Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Karepa Window World" },
};

export const INITIAL_STATE: KarepaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
