import type { BandhejVersion } from "@/app/view/HomePage/compo/styles/bandhej/bandhejPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = BandhejVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Bandhej" },
  V2: { badge: "ARTISAN", title: "Dimensional Bandhej" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Bandhej" },
};

export const INITIAL_STATE: BandhejState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
