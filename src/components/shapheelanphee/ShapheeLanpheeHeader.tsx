...
interface ShapheeLanpheeHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ShapheeLanpheeHeader({style, onStyleChange, onClose, disabled}: ShapheeLanpheeHeaderProps) {
