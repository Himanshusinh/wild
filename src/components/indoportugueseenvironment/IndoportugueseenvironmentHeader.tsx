...
interface IndoportugueseenvironmentHeaderProps {
  style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
}

export function IndoportugueseenvironmentHeader({ style, onStyleChange, onClose }: IndoportugueseenvironmentHeaderProps) {
