...
interface IndoportugueseenvironmentHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function IndoportugueseenvironmentHeader({style, onStyleChange, onClose, disabled}: IndoportugueseenvironmentHeaderProps) {
    ...
    <header className="flex shrink-0 items-center justify-between border-b border-white/10 bg-[#0E0E12] px-5 py-3">
      <div className="flex items-center gap-3">
        <StyleFilterDropdown
          ...
          value="indoportugueseenvironment"
