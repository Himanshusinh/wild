...
interface BasohlipaintingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BasohlipaintingHeader({style, onStyleChange, onClose, disabled}: BasohlipaintingHeaderProps) {
