...
export interface BasohlipaintingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Basohlipainting" },
  V2: { badge: "ARTISAN", title: "Dimensional Basohlipainting" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Basohlipainting" },
};

export const INITIAL_STATE: BasohlipaintingState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
