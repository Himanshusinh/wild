...
interface KolhapuriChappalHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function KolhapuriChappalHeader({style, onStyleChange, onClose, disabled}: KolhapuriChappalHeaderProps) {
