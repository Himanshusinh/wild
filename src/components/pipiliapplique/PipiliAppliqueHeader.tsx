...
interface PipiliAppliqueHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function PipiliAppliqueHeader({style, onStyleChange, onClose, disabled}: PipiliAppliqueHeaderProps) {
