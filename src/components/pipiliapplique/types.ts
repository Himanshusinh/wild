import type { PipiliAppliqueVersion } from "@/app/view/HomePage/compo/styles/pipiliapplique/pipiliappliquePromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = PipiliAppliqueVersion;
...
export interface PipiliAppliqueState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Pipili Appliqué" },
  V2: { badge: "ARTISAN", title: "Dimensional Pipili Appliqué" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Pipili Appliqué" },
};

export const INITIAL_STATE: PipiliAppliqueState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
