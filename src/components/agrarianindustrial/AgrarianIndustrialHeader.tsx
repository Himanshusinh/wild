...
interface AgrarianIndustrialHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function AgrarianIndustrialHeader({style, onStyleChange, onClose, disabled}: AgrarianIndustrialHeaderProps) {
