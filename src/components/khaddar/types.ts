...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Khaddar" },
  V2: { badge: "ARTISAN", title: "Dimensional Khaddar" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Khaddar" },
};

export const INITIAL_STATE: KhaddarState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
