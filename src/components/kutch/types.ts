...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Kutch Embroidery (Gujarat)" },
  V2: { badge: "ARTISAN", title: "Dimensional Kutch Embroidery Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Kutch Embroidery World" },
};

export const INITIAL_STATE: KutchState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
