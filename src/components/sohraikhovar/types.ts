import type { SohraiKhovarVersion } from "@/app/view/HomePage/compo/styles/sohraikhovar/sohraikhovarPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = SohraiKhovarVersion;
...
export interface SohraiKhovarState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const INITIAL_STATE: SohraiKhovarState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
