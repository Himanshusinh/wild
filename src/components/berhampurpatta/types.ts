...
export interface BerhampurPattaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Berhampur Patta" },
  V2: { badge: "ARTISAN", title: "Dimensional Berhampur Patta" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Berhampur Patta" },
};

export const INITIAL_STATE: BerhampurPattaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
