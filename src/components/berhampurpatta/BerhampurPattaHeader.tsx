...
interface BerhampurPattaHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BerhampurPattaHeader({style, onStyleChange, onClose, disabled}: BerhampurPattaHeaderProps) {
