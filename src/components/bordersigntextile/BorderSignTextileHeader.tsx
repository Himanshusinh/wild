...
interface BorderSignTextileHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BorderSignTextileHeader({style, onStyleChange, onClose, disabled}: BorderSignTextileHeaderProps) {
