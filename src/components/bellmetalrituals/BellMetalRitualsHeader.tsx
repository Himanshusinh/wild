...
interface BellMetalRitualsHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BellMetalRitualsHeader({style, onStyleChange, onClose, disabled}: BellMetalRitualsHeaderProps) {
