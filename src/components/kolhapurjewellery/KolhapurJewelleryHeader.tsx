...
interface KolhapurJewelleryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function KolhapurJewelleryHeader({style, onStyleChange, onClose, disabled}: KolhapurJewelleryHeaderProps) {
