...
interface SonowalTextileHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SonowalTextileHeader({style, onStyleChange, onClose, disabled}: SonowalTextileHeaderProps) {
