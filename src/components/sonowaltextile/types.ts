...
export interface SonowalTextileState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Sonowal Handloom Surface" },
  V2: { badge: "ARTISAN", title: "Dimensional Sonowal World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Sonowal World" },
};

export const INITIAL_STATE: SonowalTextileState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
