...
export interface WroughtironState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Wrought Iron Style" },
  V2: { badge: "ARTISAN", title: "Artisan Wrought Iron Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Wrought Iron World" },
};

export const INITIAL_STATE: WroughtironState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
