...
export interface MashruweavingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Mashru Weaving Style" },
  V2: { badge: "ARTISAN", title: "Artisan Mashru Weaving Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Mashru Weaving World" },
};

export const INITIAL_STATE: MashruweavingState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
