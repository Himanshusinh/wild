...
interface CeremonialEmblemHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function CeremonialEmblemHeader({style, onStyleChange, onClose, disabled}: CeremonialEmblemHeaderProps) {
