...
export interface AgramarbleinlayState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Agramarbleinlay" },
  V2: { badge: "ARTISAN", title: "Dimensional Agramarbleinlay" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Agramarbleinlay" },
};

export const INITIAL_STATE: AgramarbleinlayState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
