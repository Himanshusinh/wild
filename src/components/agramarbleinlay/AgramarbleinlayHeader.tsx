...
interface AgramarbleinlayHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function AgramarbleinlayHeader({style, onStyleChange, onClose, disabled}: AgramarbleinlayHeaderProps) {
