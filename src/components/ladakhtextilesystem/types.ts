...
export interface LadakhtextilesystemState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Ladakhtextilesystem" },
  V2: { badge: "ARTISAN", title: "Dimensional Ladakhtextilesystem" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Ladakhtextilesystem" },
};

export const INITIAL_STATE: LadakhtextilesystemState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
