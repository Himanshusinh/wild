import type { PatolaVersion } from "@/app/view/HomePage/compo/styles/patola/patolaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = PatolaVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Patola Pattern Surface" },
  V2: { badge: "ARTISAN", title: "Dimensional Patola World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Patola World" },
};

export const INITIAL_STATE: PatolaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
