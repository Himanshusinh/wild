import type { KalamkariVersion } from "@/app/view/HomePage/compo/styles/kalamkari/kalamkariPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = KalamkariVersion;
...
export interface KalamkariState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Block-Printed Textile" },
  V2: { badge: "ARTISAN", title: "Dimensional Object" },
  V3: { badge: "CINEMATIC", title: "Volumetric World" },
};

export const INITIAL_STATE: KalamkariState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
