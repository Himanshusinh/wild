...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Kaavi Incised Wall (Goa)" },
  V2: { badge: "ARTISAN", title: "Dimensional Incised Wall Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Kaavi Architectural World" },
};

export const INITIAL_STATE: KaaviState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
