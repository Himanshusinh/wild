...
export interface BuddhistMaskState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Buddhist Mask" },
  V2: { badge: "ARTISAN", title: "Dimensional Buddhist Mask" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Buddhist Mask" },
};

export const INITIAL_STATE: BuddhistMaskState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
