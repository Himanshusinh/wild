...
export interface MatweavingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Matweaving" },
  V2: { badge: "ARTISAN", title: "Dimensional Matweaving" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Matweaving" },
};

export const INITIAL_STATE: MatweavingState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
