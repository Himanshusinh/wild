...
export interface RosewoodinlayState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Rosewood Inlay Style" },
  V2: { badge: "ARTISAN", title: "Artisan Rosewood Inlay Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Rosewood Inlay World" },
};

export const INITIAL_STATE: RosewoodinlayState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
