...
export interface FrancotamilenvironmentState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Francotamilenvironment" },
  V2: { badge: "ARTISAN", title: "Dimensional Francotamilenvironment" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Francotamilenvironment" },
};

export const INITIAL_STATE: FrancotamilenvironmentState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
