...
interface FrancotamilenvironmentHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function FrancotamilenvironmentHeader({style, onStyleChange, onClose, disabled}: FrancotamilenvironmentHeaderProps) {
