...
interface CoastalfibercraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function CoastalfibercraftHeader({style, onStyleChange, onClose, disabled}: CoastalfibercraftHeaderProps) {
