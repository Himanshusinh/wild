...
export interface CoastalfibercraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Coastalfibercraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Coastalfibercraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Coastalfibercraft" },
};

export const INITIAL_STATE: CoastalfibercraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
