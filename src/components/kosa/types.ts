...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Kosa Silk (Chhattisgarh)" },
  V2: { badge: "ARTISAN", title: "Dimensional Kosa Textile Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Kosa Textile World" },
};

export const INITIAL_STATE: KosaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
