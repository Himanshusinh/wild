...
export interface NironalacquerState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Nirona Lacquer Style" },
  V2: { badge: "ARTISAN", title: "Artisan Nirona Lacquer Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Nirona Lacquer World" },
};

export const INITIAL_STATE: NironalacquerState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
