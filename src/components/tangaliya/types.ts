import type { TangaliyaVersion } from "@/app/view/HomePage/compo/styles/tangaliya/tangaliyaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = TangaliyaVersion;
...
export interface TangaliyaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const INITIAL_STATE: TangaliyaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
