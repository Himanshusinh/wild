...
interface MuriaWallPaintingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function MuriaWallPaintingHeader({style, onStyleChange, onClose, disabled}: MuriaWallPaintingHeaderProps) {
