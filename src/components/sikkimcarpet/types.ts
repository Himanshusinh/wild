...
export interface SikkimCarpetState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Sikkim Carpet" },
  V2: { badge: "ARTISAN", title: "Dimensional Sikkim Carpet" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Sikkim Carpet" },
};

export const INITIAL_STATE: SikkimCarpetState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
