...
export interface TawlhlohpuanState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Tawlhlohpuan Style" },
  V2: { badge: "ARTISAN", title: "Artisan Tawlhlohpuan Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Tawlhlohpuan World" },
};

export const INITIAL_STATE: TawlhlohpuanState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
