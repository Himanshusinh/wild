...
interface SarkandaArchitectureHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SarkandaArchitectureHeader({style, onStyleChange, onClose, disabled}: SarkandaArchitectureHeaderProps) {
