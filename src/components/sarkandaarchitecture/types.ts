...
export interface SarkandaArchitectureState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Sarkanda Reed Shelter" },
  V2: { badge: "ARTISAN", title: "Dimensional Sarkanda World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Sarkanda World" },
};

export const INITIAL_STATE: SarkandaArchitectureState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
