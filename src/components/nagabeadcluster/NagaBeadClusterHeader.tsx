...
interface NagaBeadClusterHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function NagaBeadClusterHeader({style, onStyleChange, onClose, disabled}: NagaBeadClusterHeaderProps) {
