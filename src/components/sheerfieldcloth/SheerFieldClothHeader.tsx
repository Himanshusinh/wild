...
interface SheerFieldClothHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SheerFieldClothHeader({style, onStyleChange, onClose, disabled}: SheerFieldClothHeaderProps) {
