...
interface SawantwadiWoodcraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SawantwadiWoodcraftHeader({style, onStyleChange, onClose, disabled}: SawantwadiWoodcraftHeaderProps) {
