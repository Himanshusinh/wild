...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Saura" },
  V2: { badge: "ARTISAN", title: "Dimensional Saura" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Saura" },
};

export const INITIAL_STATE: SauraState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
