...
export interface MataNiPachediState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Mata ni Pachedi (Gujarat)" },
  V2: { badge: "ARTISAN", title: "Dimensional Mata ni Pachedi Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Mata ni Pachedi World" },
};

export const INITIAL_STATE: MataNiPachediState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
