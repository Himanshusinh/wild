import type { IndoPortugueseVersion } from "@/app/view/HomePage/compo/styles/indoportuguese/indoportuguesePromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = IndoPortugueseVersion;
...
export interface IndoPortugueseState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const INITIAL_STATE: IndoPortugueseState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
