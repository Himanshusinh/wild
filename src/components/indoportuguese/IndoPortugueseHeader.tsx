...
interface IndoPortugueseHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function IndoPortugueseHeader({style, onStyleChange, onClose, disabled}: IndoPortugueseHeaderProps) {
