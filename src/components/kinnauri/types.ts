import type { KinnauriVersion } from "@/app/view/HomePage/compo/styles/kinnauri/kinnauriPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = KinnauriVersion;
...
export interface KinnauriState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Kinnauri Shawl (Himachal Pradesh)" },
  V2: { badge: "ARTISAN", title: "Dimensional Kinnauri Textile Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Kinnauri Textile World" },
};

export const INITIAL_STATE: KinnauriState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
