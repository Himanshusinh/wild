...
interface RajasthaniMiniatureHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function RajasthaniMiniatureHeader({style, onStyleChange, onClose, disabled}: RajasthaniMiniatureHeaderProps) {
