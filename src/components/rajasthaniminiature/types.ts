...
export interface RajasthaniMiniatureState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Rajasthani Miniature" },
  V2: { badge: "ARTISAN", title: "Dimensional Rajasthani Miniature" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Rajasthani Miniature" },
};

export const INITIAL_STATE: RajasthaniMiniatureState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
