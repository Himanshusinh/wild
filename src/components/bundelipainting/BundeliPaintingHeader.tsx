...
interface BundeliPaintingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BundeliPaintingHeader({style, onStyleChange, onClose, disabled}: BundeliPaintingHeaderProps) {
