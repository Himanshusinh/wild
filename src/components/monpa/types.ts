import type { MonpaVersion } from "@/app/view/HomePage/compo/styles/monpa/monpaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = MonpaVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Handwoven Textile" },
  V2: { badge: "ARTISAN", title: "2D/3D Woven World" },
  V3: { badge: "CINEMATIC", title: "Full 3D Woven World" },
};

export const INITIAL_STATE: MonpaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
