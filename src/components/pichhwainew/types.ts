...
export interface PichhwaiNewState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Pichhwai Style" },
  V2: { badge: "ARTISAN", title: "Artisan Pichhwai Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Pichhwai World" },
};

export const INITIAL_STATE: PichhwaiNewState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
