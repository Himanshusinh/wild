...
export interface KhatambandState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Khatamband Woodwork (Kashmir)" },
  V2: { badge: "ARTISAN", title: "Dimensional Wood Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Wood World" },
};

export const INITIAL_STATE: KhatambandState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
