...
interface ChambaMiniatureHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ChambaMiniatureHeader({style, onStyleChange, onClose, disabled}: ChambaMiniatureHeaderProps) {
