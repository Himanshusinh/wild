...
interface WoodTempleCarvingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function WoodTempleCarvingHeader({style, onStyleChange, onClose, disabled}: WoodTempleCarvingHeaderProps) {
