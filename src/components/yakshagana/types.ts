...
export interface YakshaganaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Yakshagana Style" },
  V2: { badge: "ARTISAN", title: "Artisan Yakshagana Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Yakshagana World" },
};

export const INITIAL_STATE: YakshaganaState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
