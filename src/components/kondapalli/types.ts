...
export interface KondapalliState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Carved & Painted Toy" },
  V2: { badge: "ARTISAN", title: "2D/3D Toy World" },
  V3: { badge: "CINEMATIC", title: "Full 3D Toy World" },
};

export const INITIAL_STATE: KondapalliState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
