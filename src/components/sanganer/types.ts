...
export interface SanganerState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Sanganer" },
  V2: { badge: "ARTISAN", title: "Dimensional Sanganer" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Sanganer" },
};

export const INITIAL_STATE: SanganerState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
