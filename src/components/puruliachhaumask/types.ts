...
export interface PuruliachhaumaskState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Puruliachhaumask" },
  V2: { badge: "ARTISAN", title: "Dimensional Puruliachhaumask" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Puruliachhaumask" },
};

export const INITIAL_STATE: PuruliachhaumaskState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
