import type { KhanduaVersion } from "@/app/view/HomePage/compo/styles/khandua/khanduaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = KhanduaVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Khandua" },
  V2: { badge: "ARTISAN", title: "Dimensional Khandua" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Khandua" },
};

export const INITIAL_STATE: KhanduaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
