...
export interface WoodcraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Woodcraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Woodcraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Woodcraft" },
};

export const INITIAL_STATE: WoodcraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
