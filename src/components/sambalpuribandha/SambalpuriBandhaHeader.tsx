...
interface SambalpuriBandhaHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SambalpuriBandhaHeader({style, onStyleChange, onClose, disabled}: SambalpuriBandhaHeaderProps) {
