...
export interface SambalpuriBandhaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Sambalpuri Bandha" },
  V2: { badge: "ARTISAN", title: "Dimensional Sambalpuri Bandha" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Sambalpuri Bandha" },
};

export const INITIAL_STATE: SambalpuriBandhaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
