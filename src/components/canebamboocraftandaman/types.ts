...
export interface CanebamboocraftandamanState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Canebamboocraftandaman" },
  V2: { badge: "ARTISAN", title: "Dimensional Canebamboocraftandaman" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Canebamboocraftandaman" },
};

export const INITIAL_STATE: CanebamboocraftandamanState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
