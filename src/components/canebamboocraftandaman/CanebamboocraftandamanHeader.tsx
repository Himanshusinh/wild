...
interface CanebamboocraftandamanHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function CanebamboocraftandamanHeader({style, onStyleChange, onClose, disabled}: CanebamboocraftandamanHeaderProps) {
