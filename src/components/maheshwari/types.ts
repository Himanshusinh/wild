...
export interface MaheshwariState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Maheshwari Style" },
  V2: { badge: "ARTISAN", title: "Artisan Maheshwari Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Maheshwari World" },
};

export const INITIAL_STATE: MaheshwariState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
