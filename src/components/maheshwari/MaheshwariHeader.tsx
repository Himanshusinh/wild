...
interface MaheshwariHeaderProps {
  style: StyleFamily;
...
export function MaheshwariHeader({
  style,
  onStyleChange,
  onClose,
  disabled,
}: MaheshwariHeaderProps) {
  return (
    <header className="flex items-center justify-between border-b border-white/10 bg-[#0E0E12] px-6 py-4">
      <div className="flex items-center gap-4">
        <h2 className="text-sm font-bold uppercase tracking-widest text-white">MAHESHWARI</h2>
