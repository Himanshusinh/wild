...
interface KasutiEmbroideryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function KasutiEmbroideryHeader({style, onStyleChange, onClose, disabled}: KasutiEmbroideryHeaderProps) {
