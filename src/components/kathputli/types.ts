...
export interface KathputliState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Kathputli" },
  V2: { badge: "ARTISAN", title: "Dimensional Kathputli" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Kathputli" },
};

export const INITIAL_STATE: KathputliState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
