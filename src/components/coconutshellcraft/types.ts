...
export interface CoconutshellcraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Coconutshellcraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Coconutshellcraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Coconutshellcraft" },
};

export const INITIAL_STATE: CoconutshellcraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
