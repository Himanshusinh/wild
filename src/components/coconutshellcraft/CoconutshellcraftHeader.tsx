...
interface CoconutshellcraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function CoconutshellcraftHeader({style, onStyleChange, onClose, disabled}: CoconutshellcraftHeaderProps) {
