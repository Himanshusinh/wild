...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Gabba Kashmiri Patchwork" },
  V2: { badge: "ARTISAN", title: "Dimensional Textile Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Gabba World" },
};

export const INITIAL_STATE: GabbaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
