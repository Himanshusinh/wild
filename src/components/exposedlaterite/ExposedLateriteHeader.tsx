...
interface ExposedLateriteHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ExposedLateriteHeader({style, onStyleChange, onClose, disabled}: ExposedLateriteHeaderProps) {
