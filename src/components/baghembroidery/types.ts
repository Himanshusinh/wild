...
export interface BaghEmbroideryState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Bagh" },
  V2: { badge: "ARTISAN", title: "Dimensional Bagh" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Bagh" },
};

export const INITIAL_STATE: BaghEmbroideryState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
