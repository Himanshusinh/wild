...
interface BaghEmbroideryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BaghEmbroideryHeader({style, onStyleChange, onClose, disabled}: BaghEmbroideryHeaderProps) {
