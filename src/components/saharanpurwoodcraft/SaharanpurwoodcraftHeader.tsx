...
interface SaharanpurwoodcraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SaharanpurwoodcraftHeader({style, onStyleChange, onClose, disabled}: SaharanpurwoodcraftHeaderProps) {
