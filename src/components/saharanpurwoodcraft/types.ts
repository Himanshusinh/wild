...
export interface SaharanpurwoodcraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Saharanpurwoodcraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Saharanpurwoodcraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Saharanpurwoodcraft" },
};

export const INITIAL_STATE: SaharanpurwoodcraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
