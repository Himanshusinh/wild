...
interface NeoAgrarianBrutalismHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function NeoAgrarianBrutalismHeader({style, onStyleChange, onClose, disabled}: NeoAgrarianBrutalismHeaderProps) {
