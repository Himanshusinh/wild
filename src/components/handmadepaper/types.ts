...
export interface HandmadePaperState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Bark-fiber Sheet" },
  V2: { badge: "ARTISAN", title: "2D/3D Paper World" },
  V3: { badge: "CINEMATIC", title: "Full 3D Paper World" },
};

export const INITIAL_STATE: HandmadePaperState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
