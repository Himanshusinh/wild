...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Usta Art" },
  V2: { badge: "ARTISAN", title: "Dimensional Usta Art" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Usta Art" },
};

export const INITIAL_STATE: UstaArtState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
