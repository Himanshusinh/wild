...
export interface MadhubaniState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Mithila Field (No Empty Space)" },
  V2: { badge: "ARTISAN", title: "Layered Mithila Field" },
  V3: { badge: "CINEMATIC", title: "Full 3D Mithila World" },
};

export const INITIAL_STATE: MadhubaniState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
