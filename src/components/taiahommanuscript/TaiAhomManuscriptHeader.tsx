...
interface TaiAhomManuscriptHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function TaiAhomManuscriptHeader({style, onStyleChange, onClose, disabled}: TaiAhomManuscriptHeaderProps) {
