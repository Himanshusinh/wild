...
export interface BankuraterracottaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Bankuraterracotta" },
  V2: { badge: "ARTISAN", title: "Dimensional Bankuraterracotta" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Bankuraterracotta" },
};

export const INITIAL_STATE: BankuraterracottaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
