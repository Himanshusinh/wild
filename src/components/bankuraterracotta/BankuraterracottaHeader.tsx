...
interface BankuraterracottaHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BankuraterracottaHeader({style, onStyleChange, onClose, disabled}: BankuraterracottaHeaderProps) {
