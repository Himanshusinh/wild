...
interface BastarWoodcraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BastarWoodcraftHeader({style, onStyleChange, onClose, disabled}: BastarWoodcraftHeaderProps) {
