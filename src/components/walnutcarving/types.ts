...
export interface WalnutcarvingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Walnutcarving" },
  V2: { badge: "ARTISAN", title: "Dimensional Walnutcarving" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Walnutcarving" },
};

export const INITIAL_STATE: WalnutcarvingState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
