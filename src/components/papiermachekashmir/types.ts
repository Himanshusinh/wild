...
export interface PapiermachekashmirState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Papiermachekashmir" },
  V2: { badge: "ARTISAN", title: "Dimensional Papiermachekashmir" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Papiermachekashmir" },
};

export const INITIAL_STATE: PapiermachekashmirState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
