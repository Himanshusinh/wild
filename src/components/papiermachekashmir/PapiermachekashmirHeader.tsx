...
interface PapiermachekashmirHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function PapiermachekashmirHeader({style, onStyleChange, onClose, disabled}: PapiermachekashmirHeaderProps) {
