import type { MajuliVersion } from "@/app/view/HomePage/compo/styles/majuli/majuliPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = MajuliVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Majuli Mask (Assam)" },
  V2: { badge: "ARTISAN", title: "Dimensional Majuli Mask Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Majuli Mask World" },
};

export const INITIAL_STATE: MajuliState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
