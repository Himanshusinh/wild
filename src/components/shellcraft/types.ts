import type { ShellcraftVersion } from "@/app/view/HomePage/compo/styles/shellcraft/shellcraftPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = ShellcraftVersion;
...
export interface ShellcraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Shellcraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Shellcraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Shellcraft" },
};

export const INITIAL_STATE: ShellcraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
