...
interface LambaniEmbroideryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function LambaniEmbroideryHeader({style, onStyleChange, onClose, disabled}: LambaniEmbroideryHeaderProps) {
