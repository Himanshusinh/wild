...
export interface MysorepaintingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Mysore Painting Style" },
  V2: { badge: "ARTISAN", title: "Artisan Mysore Painting Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Mysore Painting World" },
};

export const INITIAL_STATE: MysorepaintingState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
