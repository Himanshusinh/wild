...
interface TerracottacraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function TerracottacraftHeader({style, onStyleChange, onClose, disabled}: TerracottacraftHeaderProps) {
