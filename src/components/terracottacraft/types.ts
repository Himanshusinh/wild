...
export interface TerracottacraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Terracottacraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Terracottacraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Terracottacraft" },
};

export const INITIAL_STATE: TerracottacraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
