...
export interface CoircraftlakshadweepState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Coircraftlakshadweep" },
  V2: { badge: "ARTISAN", title: "Dimensional Coircraftlakshadweep" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Coircraftlakshadweep" },
};

export const INITIAL_STATE: CoircraftlakshadweepState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
