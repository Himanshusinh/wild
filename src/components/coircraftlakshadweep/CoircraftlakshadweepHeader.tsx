...
interface CoircraftlakshadweepHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function CoircraftlakshadweepHeader({style, onStyleChange, onClose, disabled}: CoircraftlakshadweepHeaderProps) {
