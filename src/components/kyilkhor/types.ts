...
export interface KyilKhorState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Sacred Diagram (Center Hierarchy)" },
  V2: { badge: "ARTISAN", title: "Handcrafted Dimensional Sacred Field" },
  V3: { badge: "CINEMATIC", title: "Full 3D Sand-Mandala World" },
};

export const INITIAL_STATE: KyilKhorState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
