...
export interface PattachitraState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Pattachitra" },
  V2: { badge: "ARTISAN", title: "Dimensional Pattachitra" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Pattachitra" },
};

export const INITIAL_STATE: PattachitraState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
