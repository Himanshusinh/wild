...
interface DhaniakhalisareeHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function DhaniakhalisareeHeader({style, onStyleChange, onClose, disabled}: DhaniakhalisareeHeaderProps) {
