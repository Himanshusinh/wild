...
export interface DhaniakhalisareeState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Dhaniakhalisaree" },
  V2: { badge: "ARTISAN", title: "Dimensional Dhaniakhalisaree" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Dhaniakhalisaree" },
};

export const INITIAL_STATE: DhaniakhalisareeState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
