...
interface RuralFiberCraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function RuralFiberCraftHeader({style, onStyleChange, onClose, disabled}: RuralFiberCraftHeaderProps) {
