...
export interface RuralFiberCraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Rural Fiber Woven Surface" },
  V2: { badge: "ARTISAN", title: "Dimensional Rural Fiber World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Rural Fiber World" },
};

export const INITIAL_STATE: RuralFiberCraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
