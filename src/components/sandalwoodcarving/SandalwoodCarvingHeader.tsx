...
interface SandalwoodCarvingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SandalwoodCarvingHeader({style, onStyleChange, onClose, disabled}: SandalwoodCarvingHeaderProps) {
