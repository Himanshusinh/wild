...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Durrie" },
  V2: { badge: "ARTISAN", title: "Dimensional Durrie" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Durrie" },
};

export const INITIAL_STATE: DurrieState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
