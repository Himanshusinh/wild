...
interface TogaluGombeyaataHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function TogaluGombeyaataHeader({style, onStyleChange, onClose, disabled}: TogaluGombeyaataHeaderProps) {
