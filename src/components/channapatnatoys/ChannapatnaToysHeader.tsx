...
interface ChannapatnaToysHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ChannapatnaToysHeader({style, onStyleChange, onClose, disabled}: ChannapatnaToysHeaderProps) {
