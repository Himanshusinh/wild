...
interface LikhaiwoodcarvingHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function LikhaiwoodcarvingHeader({style, onStyleChange, onClose, disabled}: LikhaiwoodcarvingHeaderProps) {
