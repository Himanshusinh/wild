...
export interface LikhaiwoodcarvingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Likhaiwoodcarving" },
  V2: { badge: "ARTISAN", title: "Dimensional Likhaiwoodcarving" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Likhaiwoodcarving" },
};

export const INITIAL_STATE: LikhaiwoodcarvingState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
