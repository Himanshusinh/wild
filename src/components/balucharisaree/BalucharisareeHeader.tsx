...
interface BalucharisareeHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BalucharisareeHeader({style, onStyleChange, onClose, disabled}: BalucharisareeHeaderProps) {
