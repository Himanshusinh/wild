...
export interface BalucharisareeState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Balucharisaree" },
  V2: { badge: "ARTISAN", title: "Dimensional Balucharisaree" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Balucharisaree" },
};

export const INITIAL_STATE: BalucharisareeState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
