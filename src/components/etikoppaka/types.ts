...
export interface EtikoppakaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Turned Lacquer Object" },
  V2: { badge: "ARTISAN", title: "2D/3D Lacquer World" },
  V3: { badge: "CINEMATIC", title: "Full 3D Lacquer World" },
};

export const INITIAL_STATE: EtikoppakaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
