import type { PaithaniVersion } from "@/app/view/HomePage/compo/styles/paithani/paithaniPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = PaithaniVersion;
...
export interface PaithaniState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const INITIAL_STATE: PaithaniState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
