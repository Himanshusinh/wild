...
interface BodyAugmentationHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function BodyAugmentationHeader({style, onStyleChange, onClose, disabled}: BodyAugmentationHeaderProps) {
