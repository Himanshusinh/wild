...
interface SozniembroideryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function SozniembroideryHeader({style, onStyleChange, onClose, disabled}: SozniembroideryHeaderProps) {
