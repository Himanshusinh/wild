import type { PoshinaTerracottaVersion } from "@/app/view/HomePage/compo/styles/poshinaterracotta/poshinaterracottaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = PoshinaTerracottaVersion;
...
export interface PoshinaTerracottaState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const INITIAL_STATE: PoshinaTerracottaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
