...
interface PoshinaTerracottaHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function PoshinaTerracottaHeader({style, onStyleChange, onClose, disabled}: PoshinaTerracottaHeaderProps) {
