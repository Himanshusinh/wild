...
export interface NagashawlordinaryState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Naga Shawl Style" },
  V2: { badge: "ARTISAN", title: "Artisan Naga Shawl Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Naga Shawl World" },
};

export const INITIAL_STATE: NagashawlordinaryState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
