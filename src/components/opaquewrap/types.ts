...
export interface OpaquewrapState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Opaque Wrap Style" },
  V2: { badge: "ARTISAN", title: "Artisan Opaque Wrap Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Opaque Wrap World" },
};

export const INITIAL_STATE: OpaquewrapState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
