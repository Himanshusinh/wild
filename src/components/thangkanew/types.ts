...
export interface ThangkaNewState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Thangka Style" },
  V2: { badge: "ARTISAN", title: "Artisan Thangka Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Thangka World" },
};

export const INITIAL_STATE: ThangkaNewState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
