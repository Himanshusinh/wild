...
export interface PapiermachepuducherryState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Papiermachepuducherry" },
  V2: { badge: "ARTISAN", title: "Dimensional Papiermachepuducherry" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Papiermachepuducherry" },
};

export const INITIAL_STATE: PapiermachepuducherryState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
