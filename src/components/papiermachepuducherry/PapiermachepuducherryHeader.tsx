...
interface PapiermachepuducherryHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function PapiermachepuducherryHeader({style, onStyleChange, onClose, disabled}: PapiermachepuducherryHeaderProps) {
