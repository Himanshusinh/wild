...
export interface MonpaMaskState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Ritual Mask Woodcraft" },
  V2: { badge: "ARTISAN", title: "2D/3D Woodcraft World" },
  V3: { badge: "CINEMATIC", title: "Volumetric Woodcraft World" },
};

export const INITIAL_STATE: MonpaMaskState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
