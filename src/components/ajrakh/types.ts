...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Ajrakh Resist Print (Kutch)" },
  V2: { badge: "ARTISAN", title: "Dimensional Textile Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Ajrakh World" },
};

export const INITIAL_STATE: AjrakhState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
