...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Sohrai Wall Painting Surface" },
  V2: { badge: "ARTISAN", title: "Dimensional Sohrai World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Sohrai World" },
};

export const INITIAL_STATE: SohraiState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
