...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Khatwa Applique (Bihar)" },
  V2: { badge: "ARTISAN", title: "Dimensional Khatwa Textile Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Khatwa Textile World" },
};

export const INITIAL_STATE: KhatwaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
