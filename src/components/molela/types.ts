...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Molela" },
  V2: { badge: "ARTISAN", title: "Dimensional Molela" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Molela" },
};

export const INITIAL_STATE: MolelaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
