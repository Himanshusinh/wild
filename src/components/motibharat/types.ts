...
export interface MotibharatState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Moti Bharat Style" },
  V2: { badge: "ARTISAN", title: "Artisan Moti Bharat Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Moti Bharat World" },
};

export const INITIAL_STATE: MotibharatState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
