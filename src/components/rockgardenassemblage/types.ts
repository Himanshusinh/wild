...
export interface RockgardenassemblageState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Rockgardenassemblage" },
  V2: { badge: "ARTISAN", title: "Dimensional Rockgardenassemblage" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Rockgardenassemblage" },
};

export const INITIAL_STATE: RockgardenassemblageState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
