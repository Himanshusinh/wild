...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Palmmat" },
  V2: { badge: "ARTISAN", title: "Dimensional Palmmat" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Palmmat" },
};

export const INITIAL_STATE: PalmmatState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
