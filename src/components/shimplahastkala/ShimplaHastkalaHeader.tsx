...
interface ShimplaHastkalaHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ShimplaHastkalaHeader({style, onStyleChange, onClose, disabled}: ShimplaHastkalaHeaderProps) {
