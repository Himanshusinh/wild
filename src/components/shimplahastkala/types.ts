...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Shimpla Shell Craft Surface" },
  V2: { badge: "ARTISAN", title: "Dimensional Shimpla World" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Shimpla World" },
};
