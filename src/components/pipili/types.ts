...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Pipili" },
  V2: { badge: "ARTISAN", title: "Dimensional Pipili" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Pipili" },
};

export const INITIAL_STATE: PipiliState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
