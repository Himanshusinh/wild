...
export interface PunjabJuttiState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Punjab Jutti" },
  V2: { badge: "ARTISAN", title: "Dimensional Punjab Jutti" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Punjab Jutti" },
};

export const INITIAL_STATE: PunjabJuttiState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
