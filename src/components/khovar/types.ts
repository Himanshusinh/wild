...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Khovar Marriage Wall (Jharkhand)" },
  V2: { badge: "ARTISAN", title: "Dimensional Khovar Wall Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Khovar Wall World" },
};

export const INITIAL_STATE: KhovarState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
