...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Bomkai" },
  V2: { badge: "ARTISAN", title: "Dimensional Bomkai" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Bomkai" },
};

export const INITIAL_STATE: BomkaiState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
