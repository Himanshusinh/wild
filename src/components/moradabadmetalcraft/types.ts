...
export interface MoradabadmetalcraftState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Moradabadmetalcraft" },
  V2: { badge: "ARTISAN", title: "Dimensional Moradabadmetalcraft" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Moradabadmetalcraft" },
};

export const INITIAL_STATE: MoradabadmetalcraftState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
