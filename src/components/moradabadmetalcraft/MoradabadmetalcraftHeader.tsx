...
interface MoradabadmetalcraftHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function MoradabadmetalcraftHeader({style, onStyleChange, onClose, disabled}: MoradabadmetalcraftHeaderProps) {
