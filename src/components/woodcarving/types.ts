...
export interface WoodcarvingState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Wood Carving Style" },
  V2: { badge: "ARTISAN", title: "Artisan Wood Carving Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Wood Carving World" },
};

export const INITIAL_STATE: WoodcarvingState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
