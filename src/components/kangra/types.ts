...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Kangra Lyrical Painting (Himachal)" },
  V2: { badge: "ARTISAN", title: "Dimensional Kangra Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Kangra Cinematic World" },
};

export const INITIAL_STATE: KangraState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
