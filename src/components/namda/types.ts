import type { NamdaVersion } from "@/app/view/HomePage/compo/styles/namda/namdaPromptCatalog";
import type { WarliAspectRatioChoice } from "@/components/warli/warliNanoAspect";

export type StyleFamily = NamdaVersion;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Namda" },
  V2: { badge: "ARTISAN", title: "Dimensional Namda" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Namda" },
};

export const INITIAL_STATE: NamdaState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
