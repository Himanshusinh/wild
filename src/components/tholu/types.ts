...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Shadow Puppetry" },
  V2: { badge: "ARTISAN", title: "Hybrid Puppet World" },
  V3: { badge: "CINEMATIC", title: "Volumetric Puppet World" },
};

export const INITIAL_STATE: TholuState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
