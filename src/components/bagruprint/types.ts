...
export interface BagruPrintState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Bagru" },
  V2: { badge: "ARTISAN", title: "Dimensional Bagru" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Bagru" },
};

export const INITIAL_STATE: BagruPrintState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
