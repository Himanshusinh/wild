...
export interface NgotekherhState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Ngotekherh Style" },
  V2: { badge: "ARTISAN", title: "Artisan Ngotekherh Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Ngotekherh World" },
};

export const INITIAL_STATE: NgotekherhState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
