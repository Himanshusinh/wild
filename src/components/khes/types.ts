...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Khes" },
  V2: { badge: "ARTISAN", title: "Dimensional Khes" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Khes" },
};

export const INITIAL_STATE: KhesState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
