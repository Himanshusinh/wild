...
export interface MoirangpheeState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Moirang Phee Style" },
  V2: { badge: "ARTISAN", title: "Artisan Moirang Phee Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Moirang Phee World" },
};

export const INITIAL_STATE: MoirangpheeState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
