...
export interface HimalayansacredimageState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Ladakh Sacred Thangka" },
  V2: { badge: "ARTISAN", title: "Ethereal Sacred Translation" },
  V3: { badge: "CINEMATIC", title: "Full 3D Sacred World" },
};

export const INITIAL_STATE: HimalayansacredimageState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
