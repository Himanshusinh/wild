...
interface HimalayansacredimageHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function HimalayansacredimageHeader({style, onStyleChange, onClose, disabled}: HimalayansacredimageHeaderProps) {
