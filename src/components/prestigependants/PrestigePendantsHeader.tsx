...
interface PrestigePendantsHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function PrestigePendantsHeader({style, onStyleChange, onClose, disabled}: PrestigePendantsHeaderProps) {
