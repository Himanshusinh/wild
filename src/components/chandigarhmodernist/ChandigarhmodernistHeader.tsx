...
interface ChandigarhmodernistHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function ChandigarhmodernistHeader({style, onStyleChange, onClose, disabled}: ChandigarhmodernistHeaderProps) {
