...
export interface ChandigarhmodernistState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Chandigarhmodernist" },
  V2: { badge: "ARTISAN", title: "Dimensional Chandigarhmodernist" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Chandigarhmodernist" },
};

export const INITIAL_STATE: ChandigarhmodernistState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
