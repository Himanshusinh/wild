...
export interface GaroWeavingNewState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Garo Weaving Style" },
  V2: { badge: "ARTISAN", title: "Artisan Garo Weaving Translation" },
  V3: { badge: "CINEMATIC", title: "3D Realistic Garo Weaving World" },
};

export const INITIAL_STATE: GaroWeavingNewState = {
  style: "V3",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
