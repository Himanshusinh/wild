...
export interface MalerkotlaZariState {
  style: StyleFamily;
  inputMode: InputMode;
  sceneText: string;
...
export const STYLE_LABELS: Record<StyleFamily, { badge: string; title: string }> = {
  V1: { badge: "AUTHENTIC", title: "Authentic Malerkotla Zari" },
  V2: { badge: "ARTISAN", title: "Dimensional Malerkotla Zari" },
  V3: { badge: "CINEMATIC", title: "3D Cinematic Malerkotla Zari" },
};

export const INITIAL_STATE: MalerkotlaZariState = {
  style: "V1",
  inputMode: "text",
  sceneText: "",
  uploadedImage: null,
