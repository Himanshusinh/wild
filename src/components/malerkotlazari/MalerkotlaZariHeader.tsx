...
interface MalerkotlaZariHeaderProps {style: StyleFamily;
  onStyleChange: (s: StyleFamily) => void;
  onClose: () => void;
  disabled?: boolean;
}

export function MalerkotlaZariHeader({style, onStyleChange, onClose, disabled}: MalerkotlaZariHeaderProps) {
