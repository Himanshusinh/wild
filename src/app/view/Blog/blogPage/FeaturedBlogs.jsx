    ...
    <section className="featured-blogs">
      <div className="featured-blogs-container">
        <div className="featured-blogs-header">
          ...
          <p className="featured-blogs-subtitle">
            Discover our most important guides and insights
          </p>
        </div>
                ...
                {post.image ? (
                  <img
                    ...
                    onError={(e) => {
                      ...
                      const placeholder = e.target.parentElement.querySelector('.featured-blog-image-placeholder')
