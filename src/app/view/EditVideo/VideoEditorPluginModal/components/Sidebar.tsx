...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  const tools = [
    ...
    { id: "uploads", icon: Plus, label: "Uploads" },
        ...
        {tools.map((tool) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center md:py-4 py-2 w-full transition-all relative shrink-0 ${
                isActive
            ...
            >
              ...
              <tool.icon
                ...
                strokeWidth={1.5}
              />
              <span className="md:text-sm text-[10px] font-medium md:mb-1.5 mb-0.5">
                {tool.label}
              </span>
            </button>
          );
