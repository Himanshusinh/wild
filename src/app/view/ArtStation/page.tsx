        ...
        <div className="flex-1 min-w-0 px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8">
              ...
              return (
                ...
                >
                  <div className="relative w-full rounded-2xl overflow-hidden ring-1 ring-gray-200 dark:ring-white/10 bg-gray-50 dark:bg-white/5 group shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="absolute inset-0 ring-1 ring-transparent group-hover:ring-blue-400 dark:group-hover:ring-white/20 rounded-2xl pointer-events-none transition" />
                  </div>
                </div>
              )
            })}
          ...
          {loading && items.length > 0 && (
            <div className="text-center py-8">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 dark:border-white"></div>
              <p className="text-gray-600 dark:text-white/60 mt-2">Loading more...</p>
            </div>
          )}
          ...
          {loading && items.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 dark:text-white/60 mt-4">Loading Art Station...</p>
            </div>
          )}
            ...
            <div className="fixed inset-0 bg-black/80 dark:bg-black/80 backdrop-blur-sm z-40 flex items-center justify-center p-4" onClick={() => setPreview(null)}>
                ...
                <div className="pt-[52px] h-[calc(92vh-52px)] md:flex md:flex-row md:gap-0">
                  ...
                  <div className="p-4 md:p-5 text-gray-900 dark:text-white border-t md:border-t-0 md:border-l border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-black/30 h-[52vh] md:h-full md:w-[34%] overflow-y-auto custom-scrollbar">
                    ...
                    {/* Date */}
                    <div className="mb-4">
                      <div className="text-gray-500 dark:text-white/60 text-xs uppercase tracking-wider mb-1">Date</div>
                      <div className="text-gray-900 dark:text-white text-sm">{new Date(preview.item.createdAt || preview.item.updatedAt || '').toLocaleString()}</div>
                    </div>
                    ...
                    <div className="pb-4 ">
                      ...
                      <div className="text-gray-800 dark:text-white/90 text-sm leading-relaxed whitespace-pre-wrap">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="space-y-2">
                          {((preview.item as any).audios as any[]).map((au: any, idx: number) => (
                            ...
                            >
                              <div className="flex items-center gap-2 text-sm text-gray-800 dark:text-white/90">
                                <span className="flex w-6 h-6 rounded-full bg-gray-200 dark:bg-white/10 items-center justify-center">{idx+1}</span>
