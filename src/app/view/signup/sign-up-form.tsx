...
export default function SignInForm() {
  ...
  return (
    <div className="w-full h-full flex flex-col px-4 sm:px-6 md:px-10 lg:px-auto  bg-[#1E1E1E] relative overflow-x-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-l from-[#07070B]/90 via-transparent to-transparent pointer-events-none"></div>
      ...
      <div className="flex-1 flex items-center justify-center overflow-hidden">
        <div className="w-full max-w-lg space-y-4 px-1 sm:px-0">
          ...
          {!otpSent && !showUsernameForm && !showLoginForm && (
            <div className="text-start space-y-2 mb-3">
              <h1 className="text-2xl md:text-2xl  mb:text-2xl lg:text-3xl font-semibold text-white">Welcome to WildMind!</h1>
          ...
          {showUsernameForm ? (
            <div className="space-y-2 md:space-y-2 mb:space-y-4 lg:space-y-4">
              ...
              <div className="text-start space-y-2 mb-4">
                <h1 className="text-2xl md:text-2xl  mb:text-2xl lg:text-3xl font-semibold text-white">Verification Successful!</h1>
                <p className="text-white text-sm font-light">Last step, Make a Unique Username</p>
              </div>

              {/* Username Input */}
              <div className="space-y-1">
                <label className="text-white font-medium text-base">Enter User Name</label>
                <input
                  type="text"
                  placeholder="Enter your username"
                  value={username}
                  onChange={(e) => setUsername(e.target.value)}
                  className="w-full px-4 py-2 mt-2 bg-[#171717] border border-[#464646] placeholder-[#9094A6] focus:outline-none focus:border-[#5AD7FF] rounded-full text-white text-base"
                  required
                />
              ...
              <button
                ...
                className="w-full bg-[#1C303D] hover:bg-[#3367D6] disabled:bg-[#3A3A3A] disabled:text-[#9B9B9B] py-2 rounded-full font-semibold text-base text-white transition-all duration-200"
              >
            ...
            <div className="space-y-3">
              ...
              <div className="text-start space-y-2 mb-4">
                ...
                <p className="text-white text-sm font-light">Do you have a redeem code? Apply it now to get additional credits, or continue with the free plan.</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 mt-2 bg-[#171717] border border-[#464646] placeholder-[#9094A6] focus:outline-none focus:border-[#5AD7FF] rounded-full text-white text-base uppercase"
                />
              ...
              <div className="space-y-4 mt-6">
                ...
                {redeemCode && !redeemCodeValidated ? (
                  ...
                  <button
                    ...
                    disabled={processing}
                    className="w-full bg-green-600 hover:bg-green-700 disabled:bg-[#3A3A3A] disabled:text-[#9B9B9B] py-2 rounded-full font-semibold text-base text-white transition-all duration-200"
                  >
                ...
                <button
                  ...
                  disabled={processing}
                  className="w-full bg-[#2e2e2e] hover:bg-[#3e3e3e] border border-[#464646] py-2 rounded-full font-semibold text-base text-white transition-all duration-200"
                >
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <div className="text-start space-y-2 mb-4">
                ...
                <p className="text-white text-sm font-light">Enter your Credentials to access your account.</p>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-white font-medium text-base">Email address / User Name</label>
                <input
                  type="text"
              ...
              <button
                type="submit"
                disabled={processing}
                className="w-full bg-[#1C303D] hover:bg-[#3367D6] disabled:bg-[#464646] py-2 rounded-full font-semibold text-base text-white transition-all duration-200"
              >
              ...
              <div className="text-center mb-2">
                ...
                <button
                  ...
                  className="text-[#4285F4] underline cursor-pointer text-sm font-medium"
                >
                  Sign Up
                </button>
              </div>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-3">
              {/* Title */}
              <div className="text-start space-y-2 mb-4">
                <h1 className="text-3xl font-semibold text-white">Verify code</h1>
                <p className="text-white text-sm font-light">An authentication code has been sent to your email.</p>
              </div>

              {/* Code Input */}
              <div className="space-y-1">
                <label className="text-white font-medium text-base">Enter Code</label>
                <input
                  type="text"
              ...
              <button
                ...
                className={`w-full py-2 rounded-full font-semibold text-base transition-all duration-200 ${processing || otp.length < 4
            ...
            <>
              ...
              <form onSubmit={handleSendOtp} className="space-y-3">
                <div className="space-y-0.5">
                  <label className="text-white font-medium text-sm md:text-sm mb:text-xs lg:text-sm">Email address</label>
                  <input
                    type="email"
                    placeholder="Enter your email"
                    value={email}
                    ...
                    autoComplete="email"
                    className="w-full px-4 py-1.5 mt-1 bg-[#171717] border border-[#464646] placeholder-[#9094A6] focus:outline-none focus:border-[#5AD7FF] rounded-full text-white text-base"
                    required
                  />
                </div>
                ...
                {/* Password Field */}
                <div className="space-y-1">
                  <label className="text-white font-medium text-sm md:text-sm mb:text-xs lg:text-sm">Password</label>
                  <input
                    type="password"
                    placeholder="Enter your password"
                    value={password}
                ...
                <div className="space-y-1">
                  <label className="text-white font-medium text-sm md:text-sm mb:text-xs lg:text-sm">Confirm Password</label>
                  <input
                    type="password"
                ...
                <div className="flex items-start space-x-3 mt-4 md:mt-4 mb:mt-4 lg:mt-4">
                  ...
                  />
                  <label htmlFor="terms" className="text-sm md:text-sm mb:text-xs lg:text-sm text-[#A0A0A0]">
                    I agree to the{" "}
                    <span className="text-[#5AD7FF] underline cursor-pointer text-sm md:text-sm mb:text-xs lg:text-sm">terms & policy</span>
                  </label>
                </div>
                ...
                <button
                  ...
                  className={`w-full mx-auto py-2 rounded-full font-semibold text-base transition-all duration-200 ${processing || !termsAccepted
                      ? "bg-[#3A3A3A] text-[#9B9B9B] cursor-not-allowed"
                      : "bg-[#1C303D] hover:bg-[#3367D6] text-white"
                    }`}
                >
