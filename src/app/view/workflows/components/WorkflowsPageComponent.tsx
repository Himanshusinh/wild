...
export function WorkflowsPageComponent({ initialCategory = 'All', basePath = '/view/workflows', initialWorkflowId, initialWorkflow, workflows }: { initialCategory?: string; basePath?: string; initialWorkflowId?: string; initialWorkflow?: Workflow; workflows?: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-[#07070B] text-white font-sans selection:bg-white/10 selection:text-white relative">
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "url('https://idr01.zata.ai/devstoragev1/public/noise.svg')" }}></div>
