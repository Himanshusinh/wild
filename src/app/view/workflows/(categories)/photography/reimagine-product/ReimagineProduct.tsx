          ...
          <div className="flex w-full h-full">
            <div className="w-full md:w-[48%] p-8 lg:p-12 flex flex-col border-r border-white/5 bg-[#0A0A0A] relative z-20 overflow-y-auto">
              <div className="flex-1">
                ...
                <div className="mb-6">
                  <label className="text-[10px] font-bold uppercase text-slate-500 mb-3 block ml-1">Dynamic Camera Angle</label>
                  <div className="flex flex-wrap gap-2">
                    {CAMERA_ANGLES.map((angle) => (
                      <button
                        key={angle}
                        onClick={() => setSelectedAngle(angle)}
                        className={`px-4 py-2 rounded-xl text-xs font-medium border transition-all ${selectedAngle === angle
                          ? 'bg-[#60a5fa]/10 border-[#60a5fa] text-[#60a5fa] shadow-[0_0_15px_rgba(96,165,250,0.1)]'
                          : 'bg-black/20 border-white/10 text-slate-400 hover:border-white/20 hover:bg-black/30'
                          }`}
                      >
                        {angle}
                      </button>
                ...
                <div className="mb-4">
                  <label className="text-xs font-bold uppercase text-slate-500 mb-2 block tracking-tight">ADDITIONAL DETAILS (OPTIONAL)</label>
                  <textarea
