...
export default function FusionStyles() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || error.message || 'Failed to fuse styles');
    } finally {
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadFileWithNaming(generatedImage, null, 'image', 'fusion-styles-result');
              ...
              <div className="flex-1">
                ...
                <div className="mb-8">
                  ...
                  <textarea
                    ...
                    placeholder="E.g., Make the background more vibrant, add a specific element..."
                ...
                <div className="relative w-full h-full flex items-center justify-center p-8">
                  ...
                  {isGenerating && (
                    <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center z-10 transition-all duration-500">
                      ...
                      <p className="text-white font-medium text-lg animate-pulse">Fusing styles...</p>
                    </div>
                  )}
                </div>
              ) : (
