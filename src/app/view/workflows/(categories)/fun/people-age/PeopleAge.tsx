...
export default function PeopleAge() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || error.message || 'Failed to transform age');
    } finally {
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadFileWithNaming(generatedImage, null, 'image', 'people-age-result');
          ...
          <div className="flex w-full h-full flex-col md:flex-row">
            ...
            <div className="w-full md:flex-1 h-[45%] md:h-full items-center justify-center bg-[#050505] relative overflow-hidden flex border-t md:border-t-0 md:border-l border-white/10 shrink-0">
              ...
              {originalImage && generatedImage ? (
                ...
                <div className="relative w-full h-full flex items-center justify-center p-8">
                  <ImageComparisonSlider
                    beforeImage="https://idr01.zata.ai/devstoragev1/public/workflow-samples/people-age-before.avif"
                    afterImage="https://idr01.zata.ai/devstoragev1/public/workflow-samples/people-age-after.avif"
                    beforeLabel="Before"
                    afterLabel="After"
                    imageFit="object-cover"
                  />
