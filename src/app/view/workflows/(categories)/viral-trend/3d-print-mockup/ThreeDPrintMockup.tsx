...
export default function ThreeDPrintMockup() {
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadFileWithNaming(generatedImage, null, 'image', '3d-print-result');
              ...
              <div className="flex-1">
                ...
                <div className="mb-8 animate-in fade-in slide-in-from-top-5 duration-1000">
                  ...
                  <textarea
                    ...
                    placeholder="Describe specific details for the 3d print..."
                  ></textarea>
                </div>
              </div>
                ...
                <div className="relative w-full h-full flex items-center justify-center p-8">
                  ...
                  {isGenerating && (
                    <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center z-10 transition-all duration-500">
                      ...
                      <p className="text-white font-medium text-lg animate-pulse">Generating mockup...</p>
                    </div>
                  )}
                </div>
              ) : (
