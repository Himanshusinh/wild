...
import { Tab } from "@/app/view/Generation/VideoGeneration/Editor/types";
        ...
        {tools.map((tool) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-4 w-full transition-all relative shrink-0 ${
                isActive
