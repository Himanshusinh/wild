...
import type { Track, TimelineItem, CanvasDimension, Transition, Animation } from '@/app/view/Generation/VideoGeneration/Editor/types';
import { getAdjustmentStyle, getPresetFilterStyle, getTextEffectStyle, DEFAULT_ADJUSTMENTS } from '@/app/view/Generation/VideoGeneration/Editor/types';
