...
const TextToVideo: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0E0E12] p-0 ">
          ...
          <div className="lg:w-80 space-y-6">
            ...
            <div className="bg-white/5 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">Image-to-Video Generation</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span className="text-white/80">Video-to-Video Style Transfer</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                  <span className="text-white/80">Multiple AI Models</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                  <span className="text-white/80">Customizable Parameters</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-white font-medium mb-2">Image-to-Video</h4>
                ...
                <div>
                  <h4 className="text-white font-medium mb-2">Video-to-Video</h4>
                  <div className="space-y-2 text-sm text-white/70">
