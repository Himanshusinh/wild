  ...
  return (
    <>
      <div className="relative dropdown-container">
        ...
        >
          <Layers className="h-3 w-3 md:h-4 md:w-4 shrink-0" />
          <span className="flex items-center gap-1 min-w-0 flex-shrink truncate mt-0.5">
            <span className="truncate">
              {selectedOption?.label.replace("Reference", "Ref").replace(" Fast", "")}
            </span>
