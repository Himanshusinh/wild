...
interface WanVariantOption {
  value: string;
  label: string;
  info?: string;
}

interface WanFamilyVariantDropdownProps {
  options: WanVariantOption[];
  selectedValue: string;
  onChange: (value: string) => void;
  onCloseOtherDropdowns?: () => void;
}

const WanFamilyVariantDropdown: React.FC<WanFamilyVariantDropdownProps> = ({
  options,
  selectedValue,
  onChange,
  ...
  const dropdownId = "wan-family-variant-dropdown";
...
export default WanFamilyVariantDropdown;
