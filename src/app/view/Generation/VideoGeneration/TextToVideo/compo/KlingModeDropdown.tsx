...
const KlingModeDropdown: React.FC<KlingModeDropdownProps> = ({ value, onChange, onCloseOtherDropdowns, onCloseThisDropdown }) => {
  ...
  return (
    <div className="relative dropdown-container" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-2 md:w-48 w-28 bg-black/70 backdrop-blur-xl rounded-xl overflow-hidden ring-1 ring-white/30 pb-2 pt-2 z-50">
          {options.map((opt) => (
            <button
              key={opt.value}
