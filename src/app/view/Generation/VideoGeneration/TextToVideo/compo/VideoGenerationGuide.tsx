        ...
        <section className="h-auto text-white font-sans selection:bg-[#60a5fa] selection:text-white relative overflow-hidden pt-0">
            ...
            <div className="max-w-[1500px] mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 relative">
                    ...
                    >
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[85%] transition-transform duration-500 group-hover:scale-105 group-hover:-translate-y-[55%] z-20">
...
function StepCard({ number, title, desc, img, children, color }: { number: string; title: string; desc: string; img: string; children: React.ReactNode; color: string }) {
    return (
        <div className={`group relative h-[24rem] md:max-h-[26rem] rounded-3xl bg-[#0A0A0A] border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500`}>
...
function SimulatedConfigPanel() {
    ...
    return (
        <div className="bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl p-3 flex flex-col gap-2 shadow-2xl relative overflow-hidden">
            {/* Ghost Cursor */}
            ...
            <div className="relative z-30">
                ...
                <div className={`absolute top-full left-0 right-0 mt-1 bg-[#1A1A1A] border border-white/10 rounded-lg overflow-hidden transition-all duration-200 origin-top ${step === 1 || step === 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
            ...
            <div className="relative z-20">
                ...
                <div className={`absolute top-full left-0 right-0 mt-1 bg-[#1A1A1A] border border-white/10 rounded-lg overflow-hidden transition-all duration-200 origin-top ${step === 3 || step === 4 ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
            ...
            <div className="relative z-10">
                ...
                <div className={`absolute top-full left-0 right-0 mt-1 bg-[#1A1A1A] border border-white/10 rounded-lg overflow-hidden transition-all duration-200 origin-top ${step === 5 || step === 6 ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
    ...
    return (
        <>
            ...
            <div className="absolute inset-0 h-[50%] md:max-h-[60%] overflow-hidden bg-[#050505]">
                ...
                <div className="absolute inset-0 bg-cover bg-center opacity-30 mix-blend-screen" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=800')` }}></div>
                ...
                <div className={`absolute inset-0 z-10 transition-opacity duration-1000 ${genState === 4 ? 'opacity-100' : 'opacity-0'}`}>
                    <div className="w-full h-full bg-gradient-to-br from-emerald-600/20 to-blue-600/20 flex items-center justify-center">
                        <div className="text-center">
                            <MonitorPlay size={48} className="text-emerald-400/50 mx-auto mb-2" />
                            <div className="text-emerald-400 text-xs font-bold">VIDEO GENERATED</div>
                        </div>
                    </div>
                    <div className="absolute top-4 right-4 px-3 py-1 bg-emerald-500 text-black text-[10px] font-bold rounded-full animate-in fade-in zoom-in">GENERATION COMPLETE</div>
                </div>
