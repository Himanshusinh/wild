...
const VideoModelsDropdown: React.FC<VideoModelsDropdownProps> = ({
  ...
  const getAvailableModels = () => {
    ...
    return [
      ...
      { value: "seedance-1.5-pro-t2v", label: "Seedance 1.5", description: "Text→Video & Image→Video, 2-12s, 16:9/4:3/1:1/3:4/9:16/21:9/9:21, Audio On/Off", provider: "replicate" },
