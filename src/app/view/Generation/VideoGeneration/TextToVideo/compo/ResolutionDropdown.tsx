  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        disabled={disabled}
        className={`h-[32px] px-4 rounded-lg text-[13px] font-medium ring-1 ring-white/20 hover:ring-white/30 transition flex items-center gap-1 bg-transparent text-white md:bg-white md:text-black ${
