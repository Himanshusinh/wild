  ...
  return (
    <div className="relative dropdown-container">
      ...
      {activeDropdown === 'product-generation-mode' && (
        <div className="absolute bottom-full left-0 mb-2 w-full md:w-64 bg-black/70 backdrop-blur-3xl rounded-lg overflow-hidden ring-1 ring-white/30 pb-1.5 md:pb-2 pt-1.5 md:pt-2 max-h-[50vh] overflow-y-auto dropdown-scrollbar">
          {modes.map((mode) => (
            <button
              key={mode.value}
              onClick={(e) => {
