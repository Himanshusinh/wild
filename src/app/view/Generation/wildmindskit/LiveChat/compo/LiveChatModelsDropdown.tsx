...
const LiveChatModelsDropdown: React.FC = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute bottom-full left-0 mb-2 w-56 bg-white/95 dark:bg-black/90 backdrop-blur-3xl shadow-2xl z-50 rounded-xl overflow-hidden ring-1 ring-black/20 dark:ring-white/30 pb-2 pt-2">
