  ...
  return (
    <div className="relative dropdown-container">
      ...
      {activeDropdown === 'frameSize' && (
        <div className={`absolute ${openDirection === 'down' ? 'top-full mt-2' : 'bottom-full mb-2'} left-0 w-44 bg-black/90 backdrop-blur-3xl shadow-2xl rounded-xl ring-1 ring-white/30 pb-2 pt-2 z-80 max-h-150 overflow-y-auto dropdown-scrollbar`}>
          {frameSizes.map((size) => (
            <button
              key={size.value}
              onClick={(e) => {
