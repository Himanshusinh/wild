...
import { Type, Cpu, Hash, Crop, Palette, Upload, Zap } from 'lucide-react';
...
const ImageGenerationGuide = () => {
    const steps = [
        {
            ...
            description: "Describe the image you want to generate. Be creative and detailed! ",
            description2: "You can also upload reference images (optional) for ",
            icons: [Type],
        ...
        },
        {
            ...
            description: "Choose your model, set the aspect ratio, number of images, and optionally pick a style. Customize these settings to match your creative vision.",
            icons: [Cpu, Crop, Hash, Palette],
            iconColors: ["text-[#a855f7]", "text-[#f59e0b]", "text-[#10b981]", "text-[#ec4899]"],
        ...
        },
        {
            stepNumber: 3,
            title: "Generate",
            description: "Click the Generate button to create your AI image. Watch as your prompt comes to life!",
            icons: [Zap],
    ...
    return (
        <div className="relative flex flex-col items-center justify-center h-full md:max-h-[90vh] md:h-[70vh] overflow-y-auto md:px-4 px-0 md:my-10 md:py-40 py-6 pb-40  overflow-hidden">
            ...
            <div className="relative z-10 md:max-w-7xl px-2 max-w-full w-full md:space-y-8 space-y-0">
                ...
                <div className="text-center md:space-y-4 space-y-1 ">
                    ...
                    <p className="text-slate-400 text-md md:text-xl max-w-3xl md:mx-auto md;leading-relaxed">
                        Follow these simple steps to generate stunning images with WildMind AI. 
                    </p>
                </div>
                    ...
                    {steps.map((step, index) => {
                        return (
                            ...
                            >
                                ...
                                {/* <div className="mb-6 relative z-10">
                                    <div className="flex items-center gap-3 flex-wrap">
                                        {step.icons.map((Icon, iconIndex) => (
                                            <div
                                                key={iconIndex}
                                                className="w-12 h-12 rounded-lg bg-[#111] flex items-center justify-center border border-white/10 transition-all duration-300"
                                                style={{
                                                    backgroundColor: '#111',
                                                }}
                                                onMouseEnter={(e) => {
                                                    ...
                                                    e.currentTarget.style.borderColor = step.glowColor.replace('0.3', '0.5');
                                                    e.currentTarget.style.boxShadow = `0 0 15px ${color}, 0 0 25px ${color}60`;
                                                }}
                                                onMouseLeave={(e) => {
                                            ...
                                            >
                                                <Icon className={`w-6 h-6 ${step.iconColors[iconIndex]} transition-colors`} />
                                            </div>
                                        ))}
                                    </div>
                                </div> */}
                                ...
                                <p className="text-slate-100 md:text-sm text-xs font-thin leading-relaxed relative z-10">
                                    {step.description} <br />
                                    {step.description2 && (
                                        <span className="text-slate-100 md:text-sm text-xs font-thin leading-relaxed relative z-10">
                                            {step.description2} <span className="text-slate-300 text-sm leading-relaxed relative z-10 font-extrabold">Image-to-Image generation.</span>
                                        </span>
                                    )}
                                </p>
