  ...
  return (
    <div className="relative dropdown-container">
      ...
      {activeDropdown === 'models' && (
        <div className="absolute bottom-full left-0 ml-6 md:left-0 md:translate-x-0 max-w-44 mb-2 w-12 md:w-56  bg-black/90 backdrop-blur-3xl shadow-2xl z-100 rounded-lg overflow-hidden ring-1 ring-white/30 pb-1.5 md:pb-2 pt-1.5 md:pt-2 max-h-[30vh] md:max-h-none overflow-y-auto dropdown-scrollbar">
