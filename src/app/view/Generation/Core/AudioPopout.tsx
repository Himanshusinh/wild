...
const FeatureItem = ({ href, icon: Icon, title, desc, onClick, isSoon }: any) => {
    ...
    return (
        <Element
            ...
            className={`group/item relative flex w-[250px] items-center gap-2 rounded-xl border border-transparent px-2 py-1 transition-all duration-300 overflow-hidden ${isSoon ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:bg-white/[0.03] hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]'}`}
        >
...
export const AudioPopout = ({
    ...
    return createPortal(
        <div
            ...
            className={`fixed left-[80px] z-[99999] flex max-h-[92vh] max-w-[280px] w-full flex-col overflow-hidden rounded-[24px] border border-white/10 bg-[#0E0E12]/80 backdrop-blur-2xl shadow-[0_0_80px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.05)] origin-left transition-all duration-300 ease-out font-[family-name:var(--font-poppins)]
            ...
            <div className="relative flex-1 flex flex-col h-full">
                <div className="border-b border-white/5 p-3 px-6 shrink-0 relative">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="text-md font-bold text-white tracking-wide">Audio Tools</div>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-2 px-2 custom-scrollbar relative">
                    <div className="grid grid-cols-1 gap-2">
                        ...
                        <div className="flex flex-col gap-2 relative">
                            <div className="text-[10px] font-bold text-white/30 tracking-[0.2em] uppercase pl-1 flex items-center gap-2">
