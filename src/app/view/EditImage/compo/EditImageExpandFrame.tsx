...
interface EditImageExpandFrameProps {
...
export const EditImageExpandFrame: React.FC<EditImageExpandFrameProps> = ({
    sourceImageUrl,
    ...
    // Load image
    // Prioritize showing the result (expandedImageUrl) if available.
    const previewImage = expandedImageUrl || localExpandedImageUrl || sourceImageUrl;
