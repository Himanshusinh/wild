...
const NEW_ITEMS: NewItem[] = [
  {
    ...
    media: {
      kind: "video",
      src: "https://idr01.zata.ai/devstoragev1/public/homepage/whatsnew/seedance-2.0.mp4",
      alt: "Seedance 2.0 motion preview",
      position: "center",
    },
  },
  {
    id: "new-model-happy-horse",
    eyebrow: "New Model",
    title: "Happy Horse",
    desc: "Next-gen cheerful video generation model for smooth motion and whimsical storytelling.",
    features: ["4-10s", "720p / 1080p", "T2V + I2V", "Synced Audio"],
    href: "/text-to-video?model=alibaba/happy-horse",
    color: "#FACC15",
    Icon: Sparkles,
    media: {
      kind: "video",
      src: "https://idr01.zata.ai/devstoragev1/public/homepage/whatsnew/happy-horse.mp4",
      alt: "Cheerful motion preview for Happy Horse",
      position: "center",
    },
  },
  {
  ...
  {
    id: "new-model-gpt-image-2",
    eyebrow: "New Model",
    title: "GPT Image 2",
    desc: "Advanced image generation with deeper understanding of complex prompts and artistic styles.",
    features: ["1K / 2K", "9 Ratios", "Text to Image", "Advanced Detail"],
    href: "/text-to-image?model=openai/gpt-image-2",
    color: "#EF4444",
    Icon: Sparkles,
    media: {
      kind: "image",
      src: "https://idr01.zata.ai/devstoragev1/public/homepage/whatsnew/gpt-image-2.avif",
      alt: "Artistic preview for GPT Image 2",
      position: "center",
    },
  },
  {
