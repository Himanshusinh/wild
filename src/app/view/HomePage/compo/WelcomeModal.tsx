    ...
    return (
        <div className="fixed inset-0 bg-black/70  z-[100] flex items-center justify-center p-4">
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute md:top-4 md:right-4 top-2 right-2 z-10 md:w-8 md:h-8 w-6 h-6 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-all duration-200"
                >
                ...
                <div className=" p-4 text-center">
                    <h1 className="md:text-3xl text-lg font-bold text-white mb-4">Welcome to WildMind Ai</h1>
                    <p className="text-white md:text-md text-xs leading-relaxed">
                ...
                <div className=" md:px-6 px-3 py-2">
                    {/* Features Section */}
                    <div className="mb-0">
                        <h2 className="md:text-lg text-xs font-base text-white mb-2">
                  ...
                  <span className="text-pink-600 font-semibold text-sm">AI</span>
                    ...
                    <div className="mb-2  rounded-lg ">
                        <p className="md:text-md text-xs font-base text-white mb-2 px-1">
                    ...
                    <div className="text-left">
                        <h3 className="md:text-md text-xs font-base text-white mb-2">Ready to turn your imagination into reality? Explore our tools, push creative boundaries, and discover what's possible when innovation meets affordability. Your next breakthrough is just a click away.</h3>

                        <div className=" text-white  py-3 rounded-lg md:text-md text-xs font-base inline-block mb-2">
                ...
                {/* Footer */}
                <div className=" py-0">
                    <div className="text-left md:px-6 px-3">
                        <div className="text-white md:text-md text-xs font-semibold mb-1">WildMind AI</div>
                        <div className="text-white/80 md:text-md text-xs">By WildChild Studios</div>
                    </div>
                </div>
            </div>
        </div>
