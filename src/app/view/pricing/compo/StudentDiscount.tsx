  ...
  return (
    <div className="relative text-white rounded-[2rem]
      ...
      <div className="min-h-[92px]">
        ...
        <p className="text-medium text-white/70 mx-2 justify-center text-center">
      ...
      <div className="mt-4 mx-2 justify-center text-center">
        <button className="mt-18 bg-[#1C303D] hover:bg-[#1c3c52] text-white rounded-full px-5 py-2 text-medium font-regular ring-1 ring-white/15 transition-colors jus">
          Validate Student ID
        </button>
      </div>
    </div>
