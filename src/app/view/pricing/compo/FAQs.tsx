  ...
  return (
    <div className="w-full">
      <div className="w-full">
        <h1 className="text-white text-4xl font-bold text-left mb-12">FAQs</h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8">
          {faqData.map((faq) => (
            <div 
              key={faq.id}
              className="bg-gray-800/50 rounded-2xl p-10 text-white border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-md shadow-[0_0_1px_#fff_inset,0_10px_30px_rgba(0,0,0,0.4)] w-full"
            >
