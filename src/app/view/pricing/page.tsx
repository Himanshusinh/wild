  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="flex pt-[80px]"> {/* pt-[80px] to account for fixed nav */}
        ...
        <section className="header space-y-4 px-6 py-6 w-full">
          ...
          <div className="flex items-center justify-center mt-10">
            <div className="relative">
              {/* Save 20% Badge */}
              {
                <div className="absolute -top-6  -right-8 bg-green-500 text-white text-xs font-medium px-3 py-1 rounded-3xl whitespace-nowrap">
                  Save 20% on everything
                </div>
              }
              
              {/* Toggle Container */}
              <div className="relative bg-gray-700 rounded-full p-1 w-50 h-15">
                {/* Sliding Background */}
                <div
                  className={`absolute top-1 bottom-1 w-22 rounded-full transition-all duration-300 ease-in-out ${
                    isAnnual 
                      ? 'bg-gray-300 translate-x-24' 
                ...
                <button
                  ...
                  className={`absolute left-1 top-1 bottom-1 w-22 rounded-full flex items-center justify-center transition-colors duration-300 ease-in-out focus:outline-none ${
                    !isAnnual ? 'text-gray-700' : 'text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`absolute right-1 top-1 bottom-1 w-22 rounded-full flex items-center justify-center transition-colors duration-300 ease-in-out focus:outline-none ${
                    isAnnual ? 'text-gray-700' : 'text-white'
                  }`}
                >
        ...
        <section className="pricing-packages w-full px-6 py-10 flex flex-col items-center gap-10">
          {/* {plans.map((p, i) => (
