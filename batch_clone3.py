...
styles = [
    {
        ...
        'chip2': 'BRIDAL',
        'chip3': 'GRID',
        'pdf': r'pdf_content\Gharchola - Gujarat.pdf'
    },
    {
        'id': 'godnaart',
        'compName': 'GodnaArt',
        ...
        'chip2': 'TATTOO',
        'chip3': 'NARRATIVE',
        'pdf': r'pdf_content\Godna - Bihar.pdf'
    }
]
...
'''
    ...
    src_dir = 'src/components/asharikandi' # base from previous
...
print("Batch 3 Scaffolding done")
