...
// The marker we insert before is machilipatnam's end
let stylesInsert = "";
...
// Insert after machilipatnam
creativeStyle = creativeStyle.replace(
  `  {
    id: "machilipatnam",`,
  stylesInsert + `  {
    id: "machilipatnam",` // Wait, this puts it BEFORE machilipatnam. That's fine.
);
...
console.log("Re-injected all 9 files into a clean slate.");
